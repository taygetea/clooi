...
export function getClientSettings(clientToUse, allSettings) {
    let clientOptions;
    switch (clientToUse) {
        case 'bing':
            clientOptions = {
                ...allSettings.bingAiClient,
                ...allSettings.cliOptions.bingOptions,
            };
            break;
        case 'infrastruct':
            clientOptions = {
                ...allSettings.infrastructClient,
                ...allSettings.cliOptions.infrastructOptions,
            };
            break;
        case 'claude':
            clientOptions = {
                ...allSettings.claudeClient,
                ...allSettings.cliOptions.claudeOptions,
            };
            break;
        case 'ollama':
            clientOptions = {
                ...allSettings.ollamaClient,
                ...allSettings.cliOptions.ollamaOptions,
            };
            break;
        case 'chatgpt':
            clientOptions = {
                ...allSettings.chatGptClient,
                ...allSettings.cliOptions.chatGptOptions,
            };
            break;
        case 'openrouter':
            clientOptions = {
                ...allSettings.openRouterClient,
...
export function getClient(clientToUse, allSettings) {
    let clientOptions = {
        ...getClientSettings(clientToUse, allSettings),
        cache: allSettings.cacheOptions,
    };
    let client;
    switch (clientToUse) {
